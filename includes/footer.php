          ...
          <div class="col-md-4 w3l-footer">
            <h2 class="mb-sm-3 mb-2">
              <a href="index.php" class="text-white font-italic font-weight-bold">
                <span>Blood Bank  </span> System 
                <i class="fas fa-syringe ml-2"></i>
              </a>
            </h2>
            <p>Your Blood Can Save Up to 3 Lives – A single blood donation can help multiple people in need, including accident victims, surgery patients, and those battling diseases like cancer..</p>
          </div>
...
{ ?>
        ...
        <div class="border-top mt-5 pt-lg-4 pt-3 pb-lg-0 pb-3 text-center">
          <p class="copy-right-grids mt-lg-1">©  Blood Bank System
